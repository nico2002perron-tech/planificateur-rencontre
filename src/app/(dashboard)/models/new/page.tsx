...
import { Save, Trash2, Search, X, ArrowRight, ArrowLeft, Check } from 'lucide-react';
    ...
    <div>
      ...
      <div className="max-w-4xl">
        ...
        {step === 2 && (
          <div className="space-y-6">
            <Card>
              <h3 className="font-semibold text-text-main mb-1">Configuration — {name}</h3>
              <p className="text-sm text-text-muted mb-5">Attribuez une pondération et une classe d&apos;actif à chaque titre.</p>
            ...
            <div className="flex justify-between">
              ...
              <div className="flex gap-3">
                ...
                <Button type="button" loading={loading} disabled={holdings.length === 0 || Math.abs(totalWeight - 100) > 0.5}
